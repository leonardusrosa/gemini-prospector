...
html_path = 'sites/instituto-ferreira-odontologia-rio-claro/instituto-ferreira-odontologia-rio-claro.html'
editor_path = 'sites/instituto-ferreira-odontologia-rio-claro/instituto-ferreira-odontologia-rio-claro-editor.html'

html = open(html_path, 'r', encoding='utf-8').read()

editor_layer = """<!-- PROSPECTOR-EDITOR-START -->
<style id="pe-style">
...
<div id="pe-bar">
  <strong>Modo edição — Instituto Ferreira</strong>
...
(function(){
  ...
  document.getElementById('pe-export').addEventListener('click',function(){
    ...
    var a=document.createElement('a');a.href=URL.createObjectURL(blob);a.download='instituto-ferreira-odontologia-rio-claro.html';a.click();
  });
})();
</script>
...
out = html.replace('</body>', editor_layer + '</body>')
with open(editor_path, 'w', encoding='utf-8') as f:
    f.write(out)
print(f"Editor visual gerado em: {editor_path}")
